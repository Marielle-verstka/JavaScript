...
// Dmitriy Vepretskiy
// В общем неплохо. Единственный совет. Ты в каждом методе ищешь форму. 
// DOM-элемент можно создать один раз, вернуть его в переменную и передавать ее как аргумент остальным функциям
// createForm: function() {
// var form = document.createElement('form');
// return form;
// }
